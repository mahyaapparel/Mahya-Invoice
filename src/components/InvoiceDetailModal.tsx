                ...
                <tbody className="divide-y divide-slate-100 text-xs text-slate-700">
                  <tr>
                                ...
                                <table className="text-[11px] border-collapse border border-slate-200 text-center mx-auto bg-white rounded-lg overflow-hidden">
                                  ...
                                  <tbody className="divide-y divide-slate-200 text-slate-700 font-medium">
                                    <tr>
                                      ...
                                      {order.sizeS > 0 && <td className="border-r border-slate-200 px-2 py-0.5">{order.sizeS_short ?? order.sizeS}</td>}
                                      {order.sizeM > 0 && <td className="border-r border-slate-200 px-2 py-0.5">{order.sizeM_short ?? order.sizeM}</td>}
                                      {order.sizeL > 0 && <td className="border-r border-slate-200 px-2 py-0.5">{order.sizeL_short ?? order.sizeL}</td>}
                                      {order.sizeXL > 0 && <td className="border-r border-slate-200 px-2 py-0.5">{order.sizeXL_short ?? order.sizeXL}</td>}
                                      {order.sizeXXL > 0 && <td className="border-r border-slate-200 px-2 py-0.5">{order.sizeXXL_short ?? order.sizeXXL}</td>}
                                      {activeCustomSizes.map((cs, idx) => (
                                        <td key={idx} className="border-r border-slate-200 px-2 py-0.5 font-semibold text-slate-800 bg-blue-50/30">
                                          {cs.short || 0}
                                        </td>
                                      ))}
                                      <td className="px-2 py-0.5 font-bold bg-slate-50 text-emerald-700">{order.lenganPendek || 0}</td>
                                    </tr>
                                    <tr>
                                      <td className="border-r border-slate-200 px-2 py-0.5 font-bold text-slate-600 text-left bg-slate-50">
                                        Panjang
                                      </td>
                                      {order.sizeS > 0 && <td className="border-r border-slate-200 px-2 py-0.5">{order.sizeS_long ?? 0}</td>}
                                      {order.sizeM > 0 && <td className="border-r border-slate-200 px-2 py-0.5">{order.sizeM_long ?? 0}</td>}
                                      {order.sizeL > 0 && <td className="border-r border-slate-200 px-2 py-0.5">{order.sizeL_long ?? 0}</td>}
                                      {order.sizeXL > 0 && <td className="border-r border-slate-200 px-2 py-0.5">{order.sizeXL_long ?? 0}</td>}
                                      {order.sizeXXL > 0 && <td className="border-r border-slate-200 px-2 py-0.5">{order.sizeXXL_long ?? 0}</td>}
                                      {activeCustomSizes.map((cs, idx) => (
                                        <td key={idx} className="border-r border-slate-200 px-2 py-0.5 font-semibold text-slate-800 bg-blue-50/30">
                                          {cs.long || 0}
                                        </td>
                                      ))}
                                      <td className="px-2 py-0.5 font-bold bg-slate-50 text-indigo-700">{order.lenganPanjang || 0}</td>
                                    </tr>
                                    <tr className="font-extrabold bg-slate-100 border-t border-slate-200">
                                      <td className="border-r border-slate-200 px-2 py-0.5 text-left text-slate-800">
                                        Jumlah
                                      </td>
                                      {order.sizeS > 0 && <td className="border-r border-slate-200 px-2 py-0.5">{order.sizeS}</td>}
                                      {order.sizeM > 0 && <td className="border-r border-slate-200 px-2 py-0.5">{order.sizeM}</td>}
                                      {order.sizeL > 0 && <td className="border-r border-slate-200 px-2 py-0.5">{order.sizeL}</td>}
                                      {order.sizeXL > 0 && <td className="border-r border-slate-200 px-2 py-0.5">{order.sizeXL}</td>}
                                      {order.sizeXXL > 0 && <td className="border-r border-slate-200 px-2 py-0.5">{order.sizeXXL}</td>}
                                      {activeCustomSizes.map((cs, idx) => (
                                        <td key={idx} className="border-r border-slate-200 px-2 py-0.5 font-black text-blue-900 bg-blue-100/70">
                                          {(cs.short || 0) + (cs.long || 0)}
                                        </td>
                                      ))}
                                      <td className="px-2 py-0.5 bg-blue-100 text-blue-900 font-black">{order.quantity}</td>
                                    </tr>
                                  </tbody>
                                </table>
                              );
                    ...
                    <td className="px-3 py-3 text-right font-mono font-bold text-slate-950 whitespace-nowrap align-top">
                      {formatRupiah(order.quantity * order.unitPrice)}
                    </td>
                  </tr>
                </tbody>
              </table>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4 pt-4 border-t border-slate-100">
            ...
            <div className="space-y-2.5">
              <div className="flex justify-between text-xs text-slate-600">
                ...
                <span className="font-mono font-semibold">{formatRupiah(order.quantity * order.unitPrice)}</span>
              </div>
              {order.discount > 0 && (
